...
export const TRANSLATIONS: Record<LocaleType, TranslationDictionary> = {
  en: {
    ...
    premiumMembership: "Premium Membership (₹99)",
  ...
  hi: {
    ...
    premiumMembership: "प्रीमियम सदस्यता (₹99 से)",
  ...
  mr: {
    ...
    premiumMembership: "प्रीमियम सदस्यता (₹99 पासून)",
  ...
  rj: {
    ...
    premiumMembership: "प्रीमियम मैम्बरशिप (₹99 सूं)",
