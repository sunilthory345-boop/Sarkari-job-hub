...
Present your syllabus guidance in beautiful, highly structured, bilingual (Hindi/English) markdown. Use headers, bullets, and separate sections clearly.`
  ...
  const syllabusDatabase: SyllabusTopic[] = [
    ...
    // Bank (IBPS PO, IBPS Clerk, SBI PO, SBI Clerk, BOB, PNB, RRB, RBI)
    { id: 'bank-1', subject: 'Quantitative Aptitude', topicName: 'Data Interpretation (Bar, Pie, Radar, Missing & Caselet DI)', examGroup: 'Bank', importance: 'High', details: 'Highest weightage (15-20 Qs) in IBPS/SBI PO & Clerk. High yield calculation techniques & ratio methods.' },
    { id: 'bank-2', subject: 'Quantitative Aptitude', topicName: 'Quadratic Equations (Sign Method & Root Comparisons)', examGroup: 'Bank', importance: 'High', details: 'Guaranteed 5 questions in Prelims. Master comparing roots of ax²+bx+c=0 with ay²+by+c=0 in under 90 seconds.' },
    { id: 'bank-3', subject: 'Quantitative Aptitude', topicName: 'Missing & Wrong Number Series', examGroup: 'Bank', importance: 'High', details: '5 direct questions in all bank prelims. Practice double difference, prime steps, and multiplication+addition patterns.' },
    { id: 'bank-4', subject: 'Quantitative Aptitude', topicName: 'Simplification & Approximation (BODMAS & Percentages)', examGroup: 'Bank', importance: 'High', details: '10-15 questions in Clerk Prelims and 5 in PO. Fraction-to-percentage conversions and square root shortcuts.' },
    { id: 'bank-5', subject: 'Quantitative Aptitude', topicName: 'Commercial Arithmetic (CI-SI, Profit-Loss, Time & Work, Speed-Distance)', examGroup: 'Bank', importance: 'High', details: '10 core questions. Compound interest difference formula, mixtures and alligations, and relative speed.' },
    
    { id: 'bank-6', subject: 'Reasoning Ability', topicName: 'Puzzles (Floor, Flat-Floor, Box, Month-Date & Day Based)', examGroup: 'Bank', importance: 'High', details: '15-20 questions across all banking exams. Master 2-case matrix notation for rapid zero-error puzzle solving.' },
    { id: 'bank-7', subject: 'Reasoning Ability', topicName: 'Seating Arrangements (Circular, Linear Dual-Row, Square/Polygon)', examGroup: 'Bank', importance: 'High', details: 'Facing inside/outside variations with blood relation attributes. Core scoring component in Prelims & Mains.' },
    { id: 'bank-8', subject: 'Reasoning Ability', topicName: 'Syllogisms (Only A Few, Can Never Be, Possibility Cases)', examGroup: 'Bank', importance: 'High', details: '3-5 questions. Focus on modern banking "Only a few" conditions through definitive Venn diagrams.' },
    { id: 'bank-9', subject: 'Reasoning Ability', topicName: 'Inequalities (Direct Statements & Coded Inequalities)', examGroup: 'Bank', importance: 'High', details: '3-5 questions. Open/closed gate method for solving complex comparison statements without writing.' },
    { id: 'bank-10', subject: 'Reasoning Ability', topicName: 'Coding-Decoding (New Pattern Matrix & Chinese Substitution)', examGroup: 'Bank', importance: 'High', details: 'Common element elimination method in Prelims, logic rule decoding in Mains.' },
    { id: 'bank-11', subject: 'Reasoning Ability', topicName: 'Input-Output (Machine Shuffling & Step Arrangement)', examGroup: 'Bank', importance: 'Medium', details: 'Core 5-mark set in Bank Mains. Track shifts in ascending/descending words and prime numbers.' },
    
    { id: 'bank-12', subject: 'English Language', topicName: 'Reading Comprehension (Financial, Macroeconomic & ESG Themes)', examGroup: 'Bank', importance: 'High', details: '7-10 questions in Prelims, 15 in Mains. Inference-based questions, vocabulary in context, and central idea.' },
    { id: 'bank-13', subject: 'English Language', topicName: 'Cloze Test & Double Fillers (Banking Context)', examGroup: 'Bank', importance: 'High', details: '5-7 questions. Test grammar collocations, prepositions, and tone consistency in business passages.' },
    { id: 'bank-14', subject: 'English Language', topicName: 'Error Detection & Phrase Replacement (Subject-Verb & Inversion)', examGroup: 'Bank', importance: 'High', details: '5 questions. Rules of parallelism, inverted sentences after negative adverbs, and tense concord.' },
    { id: 'bank-15', subject: 'English Language', topicName: 'Para Jumbles & Sentence Rearrangement', examGroup: 'Bank', importance: 'Medium', details: 'Mandatory in PO Prelims. Identify noun-pronoun opening sentences and concluding summary statements.' },
    
    { id: 'bank-16', subject: 'Banking & Financial Awareness', topicName: 'RBI Monetary Policy Tools (Repo, Reverse Repo, SDF, MSF, CRR, SLR)', examGroup: 'Bank', importance: 'High', details: 'Core weightage in Bank Mains and interviews. Monetary Policy Committee (MPC) bi-monthly decisions.' },
    { id: 'bank-17', subject: 'Banking & Financial Awareness', topicName: 'Non-Performing Assets (NPA) Classification, SARFAESI & IBC 2016', examGroup: 'Bank', importance: 'High', details: 'Substandard, Doubtful & Loss asset criteria (>90 days), Insolvency & Bankruptcy Code, DRT mechanisms.' },
    { id: 'bank-18', subject: 'Banking & Financial Awareness', topicName: 'Basel III Capital Accord (CRAR, Tier 1, Tier 2 Capital & CCB)', examGroup: 'Bank', importance: 'High', details: 'Risk-weighted assets, 9% minimum capital requirement, capital conservation buffers for systemic safety.' },
    { id: 'bank-19', subject: 'Banking & Financial Awareness', topicName: 'Priority Sector Lending (PSL) & Financial Inclusion (PMJDY)', examGroup: 'Bank', importance: 'High', details: '40% PSL target for commercial banks, 75% for RRBs. Agriculture (18%), Micro enterprises (7.5%), Weaker sections.' },
    { id: 'bank-20', subject: 'Banking & Financial Awareness', topicName: 'Negotiable Instruments Act 1881 (Cheques, Promissory Notes, Sec 138)', examGroup: 'Bank', importance: 'Medium', details: 'Section 138 dishonour provisions, crossing of cheques, CTS-2010 clearance guidelines, DICGC ₹5 Lakh cover.' },
    { id: 'bank-21', subject: 'Computer Aptitude', topicName: 'Digital Banking Infrastructure, UPI, NEFT/RTGS, Cyber Security & CBS', examGroup: 'Bank', importance: 'Medium', details: 'Core Banking Solutions, RTGS min ₹2 Lakh, NEFT 24x7 batches, encryption standards and phishing defenses.' },
